...
class ListContainer extends React.Component {
  ...
  getData() {
    if (this.props.filterOption === 'ibu') {
    ...
    } else if (this.props.filterOption === 'abv') {
      fetch(`https://api.punkapi.com/v2/beers?abv_gt=${this.props.value}&abv_lt=${this.props.value + 1}`)
      .then(response => response.json())
      .then(json => {
        this.setState({
          beers: json
